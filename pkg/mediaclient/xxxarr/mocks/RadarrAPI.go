...
// NewRadarrAPI creates a new instance of RadarrAPI. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRadarrAPI(t testing.TB) *RadarrAPI {
	mock := &RadarrAPI{}
	mock.Mock.Test(t)
