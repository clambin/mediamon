...
func (_e *Client_Expecter) GetCalendar(_a0 interface{}) *Client_GetCalendar_Call {
	return &Client_GetCalendar_Call{Call: _e.mock.On("GetCalendar", _a0)}
}

func (_c *Client_GetCalendar_Call) Run(run func(_a0 context.Context)) *Client_GetCalendar_Call {
